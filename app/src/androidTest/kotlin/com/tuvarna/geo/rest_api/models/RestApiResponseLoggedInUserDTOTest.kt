...
class RestApiResponseLoggedInUserDTOTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of RestApiResponseLoggedInUserDTO
        //val modelInstance = RestApiResponseLoggedInUserDTO()
