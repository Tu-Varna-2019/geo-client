...
class RestApiResponseListUserInfoDTOTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of RestApiResponseListUserInfoDTO
        //val modelInstance = RestApiResponseListUserInfoDTO()
